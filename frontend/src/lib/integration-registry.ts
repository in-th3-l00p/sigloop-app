...
const DEFAULT_CARD_SERVICE_BASE_URL = "https://card.sigloop.online"
const DEFAULT_API_SERVICE_BASE_URL = "https://api.sigloop.online"
...
export const API_SERVICE_BASE_URL =
  (typeof window !== "undefined" && (window as any).__SIGLOOP_CONFIG__?.VITE_API_SERVICE_URL)
