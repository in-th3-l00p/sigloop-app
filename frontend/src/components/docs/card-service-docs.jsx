    ...
    <div className="space-y-8">
      <div>
        <div className="flex items-center gap-2">
          <h1 className="text-2xl font-bold tracking-tight">Card Service API</h1>
  ...
  "transaction": {
    ...
    "chain": "sepolia"
      ...
      <DocSection title="Error Responses">
        <p className="text-sm text-muted-foreground">
          All errors follow a consistent format with an HTTP status code and error body.
        </p>
          ...
          <table className="w-full text-sm">
            ...
            <tbody className="text-muted-foreground">
              <tr className="border-b border-border">
                <td className="px-3 py-2 text-xs">400</td>
                <td className="px-3 py-2 font-mono text-xs">MISSING_IDEMPOTENCY_KEY</td>
                <td className="px-3 py-2 text-xs">Transaction request missing idempotency-key header</td>
              </tr>
              <tr className="border-b border-border">
                <td className="px-3 py-2 text-xs">401</td>
                <td className="px-3 py-2 font-mono text-xs">UNAUTHORIZED</td>
                <td className="px-3 py-2 text-xs">Missing or invalid x-card-secret</td>
              </tr>
              <tr className="border-b border-border">
                <td className="px-3 py-2 text-xs">402</td>
                <td className="px-3 py-2 font-mono text-xs">INSUFFICIENT_BALANCE</td>
                <td className="px-3 py-2 text-xs">Not enough balance for the transaction</td>
              </tr>
              <tr className="border-b border-border">
                <td className="px-3 py-2 text-xs">403</td>
                <td className="px-3 py-2 font-mono text-xs">CARD_PAUSED</td>
                <td className="px-3 py-2 text-xs">Card is paused, transactions rejected</td>
              </tr>
              <tr>
                <td className="px-3 py-2 text-xs">403</td>
                <td className="px-3 py-2 font-mono text-xs">POLICY_VIOLATION</td>
                <td className="px-3 py-2 text-xs">Transaction violates card policies or limits</td>
              </tr>
            </tbody>
          </table>
        </div>
